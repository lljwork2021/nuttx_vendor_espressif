  ...
  if (accel)
    {
      ...
      /* acc_scale is in LSB/g; convert to m/s^2 */

      accel->x = (float)accel_data[0] / scale_factors.acc_scale * 9.80665f;
      accel->y = (float)accel_data[1] / scale_factors.acc_scale * 9.80665f;
      accel->z = (float)accel_data[2] / scale_factors.acc_scale * 9.80665f;
  ...
  if (gyro)
    {
      ...
      /* gyro_scale is in LSB/(deg/s); convert to rad/s */
                            ...
                            FAR struct file *filep, bool enable)
{
  ...
  if (enable && lower->notify_event != NULL && lower->priv != NULL)
    {
